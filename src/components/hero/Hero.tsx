      ...
      <Container>
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col items-center px-6 pt-16 pb-14 lg:px-8">
          ...
          <div className="mt-12 flex flex-col items-center gap-5 sm:flex-row">
            <button className="group flex h-16 items-center gap-5 rounded-full bg-[#1D2747] px-8 text-lg font-semibold text-white shadow-xl transition hover:-translate-y-1">
              Explore Now
            ...
            <button className="group flex h-16 items-center gap-5 rounded-full border border-[#ECECEC] bg-white px-8 text-lg font-semibold text-[#1D2747] shadow-lg transition hover:-translate-y-1 z-30">
              Book Counsling
