        ...
        <div className="relative overflow-hidden rounded-[28px] bg-gradient-to-br from-[#A03E98] via-[#C04D9D] to-[#E1338E] px-6 py-14 text-center shadow-[0_25px_60px_rgba(0,0,0,0.18)] sm:px-10 sm:py-16 md:rounded-[40px] md:px-14 md:py-20 lg:rounded-[52px] lg:px-20 lg:py-24">
          ...
          <div className="relative z-10 mx-auto max-w-4xl">
            ...
            <div className="mt-10 flex flex-col items-center gap-4 sm:mt-12 sm:flex-row sm:justify-center lg:mt-14 lg:gap-5">
              <button onClick={() => setIsContactOpen(true)} className="w-full rounded-xl bg-white px-8 py-4 text-base font-semibold text-[#A03E98] shadow-[0_15px_35px_rgba(0,0,0,0.18)] transition-all duration-300 hover:-translate-y-1 sm:w-auto sm:min-w-[220px] sm:text-lg lg:px-10 lg:py-5">
                Apply Online Now
              </button>

              <button className="w-full rounded-xl border-2 border-white bg-transparent px-8 py-4 text-base font-semibold text-white transition-all duration-300 hover:bg-white hover:text-[#A03E98] sm:w-auto sm:min-w-[220px] sm:text-lg lg:px-10 lg:py-5">
                Download Brochure
              </button>
            </div>
          </div>
