        ...
        <div className="flex items-center justify-between gap-10">
          ...
          <div className="max-w-[610px]">
            ...
            <div className="mt-12 flex flex-wrap gap-5">
              <button className="h-14 rounded-full bg-[#9D4091] px-8 text-[16px] font-semibold text-white transition hover:bg-[#8A3880]">
                Start Your Journey
              </button>

              <button className="h-14 rounded-full border-2 border-[#9D4091] bg-white px-8 text-[16px] font-semibold text-[#9D4091] transition hover:bg-[#9D4091] hover:text-white">
                Download Brochure
              </button>
            </div>
          </div>
